    ...
    <div class="container" style="min-width:73.5%">
        ...
        <div id="mySidenav" class="sidenav bg-light">
            ...
            <div class="text-sidebar">
                <img src="http://localhost/library/imagini/profiles/davidpasarinn.png" width="100" height="100" class="picture"></img>
                <br>
                <p style="font-weight: 600; font-size: 25px; margin-bottom:0px">David Păsărin</p>
                <p style="font-weight: 600; font-size: 15px">Colegiul Național "Elena Cuza"</p>
            </div>
            <!--Spacer-->
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="submenu1" aria-expanded="false">
                    <ul class="flex-column pl-2 nav">
                        <!--Butonul de Grup 1-->
                        <li class="nav-item">
                            <a class="nav-link py-0" href="#"><span>11D fără Diriga</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link py-0" href="#"><span>Clasa a 11a D</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link py-0" href="#"><span>CN "Elena Cuza"</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link py-0" href="#"><span>Consilul Elevilor</span></a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" id="submenu2" aria-expanded="false">
                    <ul class="flex-column pl-2 nav">
                        <li class="nav-item">
                            <!--Butonul de Topicuri-->
                            <a class="nav-link py-0" href="#"><span>Informatică</span></a>
                        </li>
                    </ul>
                </div>
            </li>
        ...
        <div id="myNotification" class="sideNotification bg-light">
            ...
            <a href="#" style="font-weight: 600; color:black">Notificările mele</a>
            <!--Spacer-->
